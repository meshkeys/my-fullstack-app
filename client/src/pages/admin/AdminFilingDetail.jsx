...
function AdminFilingDetail() {
  ...
  const fetchFiling = async () => {
    try {
      const response = await axios.get(`${baseUrl}/api/admin/filings/${id}`, {
        headers,
      });
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      await axios.post(
        `${baseUrl}/api/admin/filings/${id}/message`,
        { message },
        { headers },
      );
      setMessage("");
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-500">
                    {filing.business?.user?.phoneNumber}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-500">
                    {filing.business?.businessType?.replace(/_/g, " ")}
                  </p>
                  ...
                  filing.messages?.map((msg) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          className={`text-xs mt-1 ${msg.sender === "AGENT" ? "text-gray-500" : "text-gray-400"}`}
                        >
                      ...
                      <div key={i} className="flex gap-2">
                        ...
                        {requestedDocs.length > 1 && (
                          <button
                            ...
                            onClick={() =>
                              setRequestedDocs(
                                requestedDocs.filter((_, idx) => idx !== i),
                              )
                            }
              ...
              <div className="space-y-2">
                ...
                <button
                  onClick={async () => {
                    if (
                      window.confirm(
                        "Are you sure you want to reject this filing?",
                      )
                    ) {
